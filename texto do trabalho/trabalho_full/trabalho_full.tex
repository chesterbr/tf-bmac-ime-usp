...
Eles trabalham um problema genérico de otimização, que considera o modelo estatístico não-linear:
...
Novamente, encontramos os mesmos resultados obtidos por Judge et al, conforme a Tabela \ref{resultados_gn}. O experimento com o par $(3,2)$ permite comparar a convergência com o o algoritmo de Newton-Rhapson, e observa-se convergência mais rápida para o ponto $(0.864787, 1.235749)$.
...
Valores reduzidos de $\lambda_n$ toranm o método equivalente ao método de Gauss, e valores maiores aproximam a direção daquela de declive máximo. É possível trabalhar com o escalar constante, ou começar com ele pequeno e diminuir a cada iteração, a menos que isso leve a um tamanho de passo inaceitável.
