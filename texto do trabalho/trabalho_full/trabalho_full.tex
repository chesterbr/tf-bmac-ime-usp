...
\chapter {Um Problema Econométrico}
...
[PERGUNTAR AO PROF.: vale a pena incluir os dados do experimento, ou apenas comentar que eles estão no livro? E neste caso vale a pena incluir as respostas do nosso programa, para mostrar que estão coerentes?]


\section {Resolução: Métodos de Gradiente}
