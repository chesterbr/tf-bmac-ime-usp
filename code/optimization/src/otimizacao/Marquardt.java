...
public class Marquardt {
	...
	public static void main(String[] args) {
		// Executa o m�todo para os pontos do livro, i.e., (3,2); (0,2) e
		// (1.5,0.5):
		executaMetodo(3, 2);
		//executaMetodo(0, 2);
	...
	private static void executaMetodo(double theta1, double theta2) {
		...
		int iteracao = 1; 	Matrix P = null; Matrix I = null;	Matrix grad = null; Matrix invHess = null; double[][] hess = null; Matrix theta = null; Matrix Y = null; Matrix F = null; Matrix invHess1 = null; Matrix G =  null; Matrix invHess2 =  null;  Matrix invHess3  = null; Matrix invHess4  = null;  Matrix invHess5 =  null; Matrix gradient = null; Matrix gradientPrime = null; double[] h = null; double[][] b = null; Matrix z = null;
	...
	double lambda = 0.7;
		...
		while (iteracao <=8) 
			...
			invHess3 = gradientPrime.times(z);
	...
	// Dados do problema, cf. p�gina 956 (x1 n�o est� aqui porque x1[t] = 1 para
	// qualquer t)


	/**
	 * Calcula a fun��o f para um par (theta1, theta2)
	 * 
	 * @param theta1
	 *            primeira vari�vel
	 * @param theta2
	 *            segunda vari�vel
	 * @return vetor com 20 posi��es com o resultado
	 */
	...
	/**
	 * Calcula a fun��o H para um par (theta1, theta2)
	 * 
	 * @param theta1
	 *            primeira vari�vel
	 * @param theta2
	 ...
	 * @param theta2
	 *            segunda vari�vel
	 * @return array cujos membros s�o as componentes do vetor
	 */
	 ...
	 * @param theta2
	 *            segunda vari�vel
	 * @return array 2x2 correspondente � matriz Hessiana
	 */
	private static double[][] hess(double theta1, double theta2) {
		...
		for (int t = 0; t <= 19; t++) {
			...
			hess[1][1] += 4*x3[t]*(f-y[t])+(x2[t]+2*theta2*x3[t])*(2*x2[t]+4*theta2*x3[t]);
